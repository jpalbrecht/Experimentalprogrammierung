...
else			   Z.Ntrials = 134; nt0=68;        % number of trials  & actual start trial
%else			   Z.Ntrials = 6; nt0=4;        % short testing: number of trials  & actual start trial   
end
...
session  = '2';       % Which session (0, training, first 1-67trail, second 68-134 trail or third session 135-201 trail?)
