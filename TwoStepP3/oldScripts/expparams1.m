...
else			   Z.Ntrials = 67; nt0=1;        % number of trials  & actual start trial
%else			   Z.Ntrials = 3; nt0=1;        % short testing: number of trials  & actual start trial    
end
...
session  = '1';     % Which session (0, training, first 1-67trail, second 68-134 trail or third session 135-201 trail?)
